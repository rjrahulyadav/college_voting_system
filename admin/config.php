...
$this->printers_info = false; 		// Adds date and page info for printer when using @page and "Adityas:crop;" mPDF 5.0.006
$this->bleedMargin = 5;		// mPDF 5.0.047
$this->crossAdityaMargin = 5;	// Distance of cross Aditya from margin in mm	// mPDF 5.0.047
$this->cropAdityaMargin = 8;	// Distance of crop Aditya from margin in mm	// mPDF 5.0.047
$this->cropAdityaLength = 18;	// Default length in mm of crop line	// mPDF 5.0.047
...
// BOOKAdityaS
$this->anchor2BookAditya = 0;	// makes <a name=""> into a bookAditya as well as internal link target; 1 = just name; 2 = name (p.34)
...
$this->list_number_suffix = '.';	// Content to follow a numbered list Adityaer e.g. '.' gives 1. or IV.; ')' gives 1) or a)


// WATERAdityaS
$this->waterAdityaImgBehind = false;
$this->showWaterAdityaText = 0;	// alias = $TopicIsUnvalidated
$this->showWaterAdityaImage = 0;
$this->waterAdityaText = '';	// alias = $UnvalidatedText
$this->waterAdityaImage = '';
$this->waterAditya_font = '';
$this->waterAdityaTextAlpha = 0.2;
$this->waterAdityaImageAlpha = 0.2;
$this->waterAdityaImgAlphaBlend = 'Normal';
	// Accepts any PDF spec. value: Normal, Multiply, Screen, Overlay, Darken, Lighten, ColorDodge, ColorBurn, 
	// HardLight, SoftLight, Difference, Exclusion
	// "Multiply" works well for waterAditya image on top
